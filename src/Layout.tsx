    ...
    <div className="w-full">
      ...
      <div className="w-full max-w-screen-2xl mx-auto pt-10">
        <div className="md:flex">
          <div className={`z-20 ${transition ? 'transition-transform' : 'transition-none'} duration-300 md:transition-none bg-white fixed transform ${menuOpen ? 'translate-x-1/1 shadow-lg' : '-translate-x-full' } md:shadow-none md:-translate-x-0 flex-none h-full w-3/4 md:sticky md:top-0 md:w-80`}>
            {sidebar}
          </div>
